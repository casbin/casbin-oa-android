...
public class CasdoorConfig {
    ...
    public static final String REDIRECTURI = "http://******/callback";
    ...
    public static void InitConfig(FragmentActivity activity, String endPoint, String clientID, String clientSecret, String jwtSecret, String organizationName) {
